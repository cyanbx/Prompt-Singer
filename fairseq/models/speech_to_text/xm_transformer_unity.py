...
@register_model("xm_transformer_unity")
class XMTransformerUnitYModel(XMTransformerModel):
    @classmethod
    def hub_models(cls):
        base_url = "http://dl.fbaipublicfiles.com/fairseq/s2t"
        model_ids = ["xm_transformer_unity_hk-en", "xm_transformer_unity_en-hk"]
    ...
    def from_pretrained(
        ...
        multitask_config_yaml="multitask_config.yaml",
        task="speech_to_text",
        ...
        **kwargs,
        ...
        x = hub_utils.from_pretrained(
            ...
            multitask_config_yaml=multitask_config_yaml,
            task=task,
...
@register_model_architecture(
    model_name="xm_transformer_unity", arch_name="xm_transformer_unity"
)
...
@register_model_architecture(
    model_name="xm_transformer_unity", arch_name="xm_transformer_t2"
)
