...
from fairseq.models.speech_to_speech.s2s_conformer import (
    S2SpecTConformerModel,
    S2UTConformerModel,
)
...
class UnitYConformerModel(S2UTConformerModel):
    """
    Direct speech-to-speech translation model with S2T Conformer encoder + MT Transformer decoder + Transformer discrete unit decoder
    """
...
@register_model("spect2_conformer")
class SpecT2ConformerModel(S2SpecTConformerModel):
    """
    Direct speech-to-speech translation model with S2T Conformer encoder + MT Transformer decoder + TTS Transformer decoder
    """
...
@register_model_architecture(
    model_name="spect2_conformer", arch_name="spect2_conformer"
)
...
@register_model_architecture(
    model_name="spect2_conformer", arch_name="s2spect_conformer_translatotron2"
)
